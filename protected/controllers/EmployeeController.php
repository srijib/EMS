...
class EmployeeController extends Controller
{
    ...
    */
    ...
    public function init(){
        app()->clientScript->registerCssFile(app()->request->baseUrl .'/css/employee.css');
        parent::init();
    }
    ...
    */
    public function actionIndex()
    {
        ...
        if(app()->user->checkAccess('manageProfile')){
            app()->request->redirect(app()->createUrl('/Employee/Admin'));
        } else {
